...
var G__26432 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26432;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26433 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26433,ch);
...
if(("\\" === ch__$1)){
var ch_26434__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26434__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26434__$2);
} else {
}

var G__26435 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26435;
continue;
}
}
...
var vec__26443 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26443,(0),null);
var start_column = cljs.core.nth.call(null,vec__26443,(1),null);
...
var G__26446 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26446;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__26447 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__26448 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__26448);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__26447);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26449 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26449,(0),null);
var start_column = cljs.core.nth.call(null,vec__26449,(1),null);
...
var vec__26452 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26452,(0),null);
var end_column = cljs.core.nth.call(null,vec__26452,(1),null);
...
var vec__26455 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26455,(0),null);
var start_column = cljs.core.nth.call(null,vec__26455,(1),null);
...
var vec__26458 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26458,(0),null);
var end_column = cljs.core.nth.call(null,vec__26458,(1),null);
...
var vec__26461 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26461,(0),null);
var start_column = cljs.core.nth.call(null,vec__26461,(1),null);
...
var vec__26464 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26464,(0),null);
var end_column = cljs.core.nth.call(null,vec__26464,(1),null);
...
var sb = (function (){var G__26467 = (new goog.string.StringBuffer());
G__26467.append(initch);
...
var G__26469 = (function (){var G__26468 = sb;
G__26468.append(ch);

return G__26468;
})();
var G__26470 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__26469;
ch = G__26470;
continue;
}
...
switch (G__26473) {
case "\\":
var G__26477 = (function (){var G__26474 = sb;
G__26474.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26474;
})();
var G__26478 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26477;
ch = G__26478;
continue;
...
break;
default:
var G__26479 = (function (){var G__26475 = sb;
G__26475.append(ch);

return G__26475;
})();
var G__26480 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26479;
ch = G__26480;
continue;
...
var vec__26481 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26481,(0),null);
var end_column = cljs.core.nth.call(null,vec__26481,(1),null);
...
var vec__26484 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26484,(0),null);
var column = cljs.core.nth.call(null,vec__26484,(1),null);
...
var vec__26489 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26489,(0),null);
var column = cljs.core.nth.call(null,vec__26489,(1),null);
...
var vec__26494 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26494,(0),null);
var column = cljs.core.nth.call(null,vec__26494,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26499 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26499,(0),null);
var start_column = cljs.core.nth.call(null,vec__26499,(1),null);
...
var vec__26502 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26502,(0),null);
var end_column = cljs.core.nth.call(null,vec__26502,(1),null);
...
var G__26505 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26505,true,null,opts,pending_forms);
...
var G__26506 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26506)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26506)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26506)){
...
var _STAR_suppress_read_STAR__orig_val__26507 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26508 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26508);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26507);
}});
...
var G__26509 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26509,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26509,rdr,first_line);
...
var G__26513 = matched;
var G__26514 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26513;
finished = G__26514;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__26515 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26516 = (function (){var or__4185__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26516);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26515);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__26517 = cljs.tools.reader.arg_env;
var arg_env_temp_val__26518 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__26518);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26519 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26519,"(");
...
var G__26520 = (i + (1));
var G__26521 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4185__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__26517);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26522 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26522);
...
var G__26523 = cljs.core.next.call(null,s__$1);
var G__26524 = ret;
s__$1 = G__26523;
r = G__26524;
continue;
...
var G__26525 = cljs.core.next.call(null,s);
var G__26526 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26525;
key_vals = G__26526;
continue;
} else {
...
var gensym_env_orig_val__26531 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__26532 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__26532);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__26531);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26533 = token;
var G__26533__$1 = (((G__26533 == null))?null:cljs.core.subs.call(null,G__26533,(1)));
var G__26533__$2 = (((G__26533__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26533__$1));
var G__26533__$3 = (((G__26533__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26533__$2));
var G__26533__$4 = (((G__26533__$3 == null))?null:cljs.core.symbol.call(null,G__26533__$3));
if((G__26533__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26533__$4);
}
})():(function (){var G__26534 = token;
var G__26534__$1 = (((G__26534 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26534));
if((G__26534__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26534__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26545,reader){
...
var eof = cljs.core.get.call(null,map__26546__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1574747413799
