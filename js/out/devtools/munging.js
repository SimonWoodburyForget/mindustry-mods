...
var o23042 = temp__5733__auto__;
var temp__5733__auto____$1 = (o23042["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o23043 = temp__5733__auto____$1;
return (o23043["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22883__auto__ = f;
return (o__22883__auto__["toString"]).call(o__22883__auto__);
} else {
return "";
}
}catch (e23044){var _ = e23044;
return "";
}});
...
try{var o__22883__auto___23046 = t;
(o__22883__auto___23046["cljs$lang$ctorPrWriter"]).call(o__22883__auto___23046,t,writer);
}catch (e23045){var __23047 = e23045;
}
...
var char_code = (function (){var o__22883__auto__ = (new String(char$));
return (o__22883__auto__["charCodeAt"]).call(o__22883__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22883__auto__ = String;
return (o__22883__auto__["fromCharCode"]).call(o__22883__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23048 = num_code;
switch (G__23048) {
case (1):
return (185);
...
var o__22883__auto__ = String;
return (o__22883__auto__["fromCharCode"]).call(o__22883__auto__,superscript_code);
});
/**
...
}catch (e23050){var _e__22890__auto__ = e23050;
return false;
}})())){
...
var vec__23051 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23051,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o23054 = temp__5733__auto__;
var temp__5733__auto____$1 = (o23054["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o23055 = temp__5733__auto____$1;
return (o23055["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23058){
var vec__23059 = p__23058;
var ns_detector = cljs.core.nth.call(null,vec__23059,(0),null);
...
var G__23065 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23066 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23065;
remaining_tokens = G__23066;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23056){
var G__23057 = cljs.core.first.call(null,seq23056);
var seq23056__$1 = cljs.core.next.call(null,seq23056);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23057,seq23056__$1);
}));
...
var vec__23070 = cljs.core.split_with.call(null,(function (p1__23069_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23069_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23070,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23070,(1),null);
...
var vec__23076 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23076,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23076,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23079 = cljs.core.rest.call(null,remaining_tokens);
var G__23080 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23079;
name_tokens = G__23080;
continue;
} else {
...
var vec__23083 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23083,(0),null);
var arity = cljs.core.nth.call(null,vec__23083,(1),null);
var vec__23086 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23086,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23086,(1),null);
var vec__23089 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23089,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23089,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23089,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23089,(3),null);
...
var vec__23095 = result;
var munged_ns = cljs.core.nth.call(null,vec__23095,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23095,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23095,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23095,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23095,(4),null);
var arity = cljs.core.nth.call(null,vec__23095,(5),null);
...
var munged_name = cljs.core.nth.call(null,vec__23099,(0),null);
var args = cljs.core.nth.call(null,vec__23099,(1),null);
var vec__23102 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23102,(0),null);
var name = cljs.core.nth.call(null,vec__23102,(1),null);
...
var G__23105 = (arity + (1));
var G__23106 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23107){
var vec__23108 = p__23107;
var arity = cljs.core.nth.call(null,vec__23108,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23108,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23111_SHARP_){
return cljs.core.get.call(null,arities,p1__23111_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__23112_SHARP_){
return cljs.core.drop.call(null,(2),p1__23112_SHARP_);
}),sorted_infos);
...
var args__4795__auto__ = [];
var len__4789__auto___23119 = arguments.length;
var i__4790__auto___23120 = (0);
while(true){
if((i__4790__auto___23120 < len__4789__auto___23119)){
args__4795__auto__.push((arguments[i__4790__auto___23120]));

var G__23121 = (i__4790__auto___23120 + (1));
i__4790__auto___23120 = G__23121;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23115){
var vec__23116 = p__23115;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23116,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23113){
var G__23114 = cljs.core.first.call(null,seq23113);
var seq23113__$1 = cljs.core.next.call(null,seq23113);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23114,seq23113__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23124__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23124__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23124__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23124__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23125 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23125,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23125,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23125,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23125,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23125,(4),null);
var arity = cljs.core.nth.call(null,vec__23125,(5),null);
...
var o__22883__auto__ = f;
return (o__22883__auto__["getBasis"]).call(o__22883__auto__);
});
/**
...
}catch (e23129){var _e__22890__auto__ = e23129;
...
var G__23130 = (obj[cljs.core.first.call(null,path)]);
var G__23131 = cljs.core.rest.call(null,path);
obj = G__23130;
path = G__23131;
continue;
} else {
...
var _STAR_ = (function (accum,p__23132){
var vec__23133 = p__23132;
var bit = cljs.core.nth.call(null,vec__23133,(0),null);
var protocol = cljs.core.nth.call(null,vec__23133,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23136){
var vec__23137 = p__23136;
var ns = cljs.core.nth.call(null,vec__23137,(0),null);
var name = cljs.core.nth.call(null,vec__23137,(1),null);
var selector = cljs.core.nth.call(null,vec__23137,(2),null);
...
var post_process = (function (p__23141){
var vec__23142 = p__23141;
var munged_name = cljs.core.nth.call(null,vec__23142,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23142,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23140_SHARP_){
return (obj[cljs.core.first.call(null,p1__23140_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1574747408107
