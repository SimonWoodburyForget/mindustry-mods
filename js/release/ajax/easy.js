...
var G__25939 = format;
var G__25939__$1 = (((G__25939 instanceof cljs.core.Keyword))?G__25939.fqn:null);
switch (G__25939__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__25941 = cljs.core.second(format);
var G__25942 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__25941,G__25942) : ajax.easy.keyword_response_format_element.call(null,G__25941,G__25942));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__25943 = format;
var G__25943__$1 = (((G__25943 instanceof cljs.core.Keyword))?G__25943.fqn:null);
switch (G__25943__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25945_SHARP_){
return ajax.easy.keyword_response_format_element(p1__25945_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__25946){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25947__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25947__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25947__$1,cljs.core.cst$kw$finally);
...
return (function ajax$easy$transform_handler_$_easy_handler(p__25949){
var vec__25950 = p__25949;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25950,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25950,(1),null);
var fexpr__25953_25954 = (cljs.core.truth_(ok)?h:e);
(fexpr__25953_25954.cljs$core$IFn$_invoke$arity$1 ? fexpr__25953_25954.cljs$core$IFn$_invoke$arity$1(result) : fexpr__25953_25954.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__25955){
...
var opts = map__25956__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25956__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25956__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25956__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25956__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25956__$1,cljs.core.cst$kw$body);
