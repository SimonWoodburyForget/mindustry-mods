...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__25927){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25928__$1,cljs.core.cst$kw$handler);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(request,cljs.core.cst$kw$method,ajax.simple.normalize_method),cljs.core.cst$kw$interceptors,(function (p1__25930_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4185__auto__ = p1__25930_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__25931){
...
var request = map__25932__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25932__$1,cljs.core.cst$kw$interceptors);
...
var api = (function (){var or__4185__auto__ = cljs.core.cst$kw$api.cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
