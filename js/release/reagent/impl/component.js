...
if((i < len)){
var k = (ks[i]);
var G__26415 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__26416 = (i + (1));
m = G__26415;
i = G__26416;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__26417 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__26417);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26419 = c;
var G__26419__$1 = (((G__26419 == null))?null:G__26419.prototype);
if((G__26419__$1 == null)){
return null;
} else {
return G__26419__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__26421 = c;
var G__26421__$1 = (((G__26421 == null))?null:G__26421.prototype);
if((G__26421__$1 == null)){
return null;
} else {
return G__26421__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__26425__delegate = function (args){
var G__26423 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__26423) : reagent.impl.component.as_element.call(null,G__26423));
};
...
while (G__26426__i < G__26426__a.length) {G__26426__a[G__26426__i] = arguments[G__26426__i + 0]; ++G__26426__i;}
  args = new cljs.core.IndexedSeq(G__26426__a,0,null);
} 
return G__26425__delegate.call(this,args);};
...
return G__26425__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__26429 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__26430 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__26430);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__26429);
}});
...
var c = this;
var G__26434_26436 = goog.object.get(c,"cljsRatom");
if((G__26434_26436 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26434_26436);
}
...
var renders_26437 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_26438 = cljs.core.first(cljs.core.vals(renders_26437));
...
if((cljs.core.count(renders_26437) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_26437))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_26438)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_26438], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__26439 = o;
goog.object.set(G__26439,cljs.core.name(k),v);
...
var name = (function (){var G__26440 = fiber;
var G__26440__$1 = (((G__26440 == null))?null:G__26440.type);
if((G__26440__$1 == null)){
return null;
} else {
return G__26440__$1.displayName;
}
})();
var parent = (function (){var G__26441 = fiber;
if((G__26441 == null)){
return null;
} else {
return G__26441.return;
}
})();
var path = (function (){var G__26442 = parent;
var G__26442__$1 = (((G__26442 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__26442) : reagent.impl.component.fiber_component_path.call(null,G__26442)));
if((G__26442__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26442__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__26444 = c;
if((G__26444 == null)){
return null;
} else {
return goog.object.get(G__26444,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__26445._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__26447 = c;
if((G__26447 == null)){
return null;
} else {
return goog.object.get(G__26447,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__26449 = c;
if((G__26449 == null)){
return null;
} else {
return G__26449._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__26451 = instance;
if((G__26451 == null)){
return null;
} else {
return goog.object.get(G__26451,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__26452 = instance;
if((G__26452 == null)){
return null;
} else {
return G__26452._currentElement;
}
}
})();
var name = (function (){var G__26453 = elem;
var G__26453__$1 = (((G__26453 == null))?null:G__26453.type);
if((G__26453__$1 == null)){
return null;
} else {
return G__26453__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__26455 = elem;
if((G__26455 == null)){
return null;
} else {
return goog.object.get(G__26455,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__26456._owner;
}
}
})();
var path = (function (){var G__26457 = owner;
var G__26457__$1 = (((G__26457 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__26457) : reagent.impl.component.component_path.call(null,G__26457)));
if((G__26457__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26457__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__26458 = c;
var G__26458__$1 = (((G__26458 == null))?null:G__26458.constructor);
if((G__26458__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__26458__$1);
}
}
})();
